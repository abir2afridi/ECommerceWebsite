              ...
              <div className="details-product-area">
                ...
                <div className="contents">
                  ...
                  <div className="share-social">
                    <span>Share:</span>
                    <a className="platform" href="http://facebook.com" target="_blank" rel="noopener noreferrer"><i className="fab fa-facebook-f" /></a>
                    <a className="platform" href="http://twitter.com" target="_blank" rel="noopener noreferrer"><i className="fab fa-twitter" /></a>
                    <a className="platform" href="http://behance.com" target="_blank" rel="noopener noreferrer"><i className="fab fa-behance" /></a>
                    <a className="platform" href="http://youtube.com" target="_blank" rel="noopener noreferrer"><i className="fab fa-youtube" /></a>
                    <a className="platform" href="http://linkedin.com" target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin" /></a>
                  </div>
                </div>
              </div>
            </div>

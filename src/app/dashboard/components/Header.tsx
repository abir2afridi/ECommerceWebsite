      ...
      <div className="header-right">
        <div className="action-interactive-area__header" ref={popupRef}>
          ...
          >
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path
                d="M6.5 18C5.95 18 5.479 17.804 5.088 17.413C4.696 17.021 4.5 16.55 4.5 16C4.5 15.45 4.696 14.979 5.088 14.588C5.479 14.196 5.95 14 6.5 14C7.05 14 7.521 14.196 7.913 14.588C8.304 14.979 8.5 15.45 8.5 16C8.5 16.55 8.304 17.021 7.913 17.413C7.521 17.804 7.05 18 6.5 18ZM14.5 18C13.95 18 13.479 17.804 13.088 17.413C12.696 17.021 12.5 16.55 12.5 16C12.5 15.45 12.696 14.979 13.088 14.588C13.479 14.196 13.95 14 14.5 14C15.05 14 15.521 14.196 15.913 14.588C16.304 14.979 16.5 15.45 16.5 16C16.5 16.55 16.304 17.021 15.913 17.413C15.521 17.804 15.05 18 14.5 18ZM2.5 2.5V4.5H4L6.5 11.5L5.5 13.5C5.333 13.833 5.25 14.167 5.25 14.5C5.25 15.2 5.5 15.808 6 16.317C6.5 16.825 7.108 17.079 7.825 17.079H14.5V15.079H8.175C7.942 15.079 7.75 14.996 7.6 14.829C7.45 14.663 7.375 14.467 7.375 14.242C7.375 14.108 7.4 13.979 7.45 13.854L8.2 12H14C14.55 12 15.021 11.804 15.413 11.413C15.804 11.021 16 10.55 16 10V7.5H14.5V10H7.5L5.5 5.5H14.5V3.5H2.5Z"
                fill="#083A5E"
              />
            </svg>
            {cartCount > 0 && (

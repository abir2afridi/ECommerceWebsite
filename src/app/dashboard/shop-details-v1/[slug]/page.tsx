...
export default function ShopDetailsSlug() {
  ...
  const product = Product.find((p: any) => p.slug === slug) || Product[0];
  const productImage = `/assets/images/grocery/${product.image}`;

  const thumbnails = [
    { id: "one", src: productImage, alt: "product" },
                  ...
                  <div className="product-details-popup">
                    <div className="details-product-area">
                      ...
                      <div className="contents">
                        ...
                        <p className="mt--20 mb--20">Modern design product. Comfortable to wear. Buy it at the best price.</p>
                        <span className="product-price mb--15 d-block" style={{ color: "#DC2626", fontWeight: 600 }}>
                          ₹{product.price} <span className="old-price ml--15">₹69.35</span>
                        </span>
                        ...
                        <div className="product-uniques">
                          ...
                          <span className="catagorys product-unipue mb--10"><span style={{ fontWeight: 400, marginRight: 10 }}>Categories:</span> {product.category}</span>
